    ...
    <article class="card relative overflow-x-auto shadow-md sm:rounded-lg px-6 py-3">
        <div class="group relative grow">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-3 py-12  place-items-center">
                <button data-modal-target="crud-modal-fakultas" data-modal-toggle="crud-modal-fakultas"
                ...
                <table class="w-fixed text-sm text-left rtl:text-right text-gray-200 dark:text-gray-200 ">
                    <thead class=" text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-200">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Nama Singkat</th>
                            <th></th>
                            <th></th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($fakultas as $fakultas)
                            <tr
                                ...
                                <td class="px-1 py-1 text-gray-900">
                                    ...
                                    href="{{ url('ubahfakultas/' . $fakultas->id_fakultas) }}">
                                    Edit
                                </a>
                                </td>
                                <td class="px-1 py-1 text-gray-900">
                                <form action="{{ url('hapusfakultas/' . $fakultas->id_fakultas) }}" method="post">
                                    @method('delete')
                                    @csrf
                                    <button class="bg-red-500 hover:bg-red-700 text-white font-sans py-1 px-1 text-xs rounded"
                                     onclick="return confirm('Yakin dihapus ta om? (iki datae fakultas)')">
                                       <span>hapus</span>
                                    </button>
                                 </form>
                                </td>
        ...
        <div id="crud-modal-fakultas" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="crud-modal-fakultas">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" action="{{ url('/simpanfakultas') }}"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="singkat"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Singkatan Fakultas</label>
                            <input type="text" name="singkat" id="singkat"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="" required="">
                        </div>
                    </div>
