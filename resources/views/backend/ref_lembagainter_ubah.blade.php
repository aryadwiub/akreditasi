    ...
    <div class=" max-h-full place-items-center">
        <div class="relative p-4  max-w-md max-h-full ">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 ">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" action="{{ url('ubahsimpanlembagainter/' . $ambil->id_akre) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                placeholder="" required="" value="{{ $ambil->nama_lembaga }}">
                        </div>
                    </div>
                    <button type="submit"
                    ...
                    <a href="{{ url('referensilembagainter') }}" 
