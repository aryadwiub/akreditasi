    ...
    <article class="card relative overflow-x-auto shadow-md sm:rounded-lg px-6 py-3">
        <div class="group relative grow">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-3 py-12  place-items-center">
                <button data-modal-target="crud-modal-peringkat" data-modal-toggle="crud-modal-peringkat"
                    ...
                    type="button">
                    Tambah Data Peringkat Nasional
                </button>
                <br>
                <table class="w-fixed text-sm text-left rtl:text-right text-gray-200 dark:text-gray-200 ">
                    <thead class=" text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-200">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Nama Peringkat</th>
                            <th scope="col" class="px-6 py-3">Kode Peringkat</th>
                            <th></th>
                            <th></th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($peringkat as $peringkat)
                            <tr
                                ...
                                <td class="px-1 py-1 text-gray-900">
                                    ...
                                    href="{{ url('ubahperingkat/' . $peringkat->kode) }}">
                                    Edit
                                </a>
                                </td>
                                <td class="px-1 py-1 text-gray-900">
                                <form action="{{ url('hapusperingkat/' . $peringkat->kode) }}" method="post">
                                    @method('delete')
                                    @csrf
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" action="{{ url('/simpanperingkat') }}"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="nama"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Peringkat</label>
                        ...
                        <div class="col-span-2">
                            <label for="kode"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kode Peringkat</label>
