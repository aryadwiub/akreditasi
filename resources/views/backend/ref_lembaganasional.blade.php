    ...
    <article class="card relative overflow-x-auto shadow-md sm:rounded-lg px-6 py-3">
                ...
                <table class="w-fixed text-sm text-left rtl:text-right text-gray-200 dark:text-gray-200 ">
                    <thead class=" text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-200">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Nama Lembaga</th>
                            <th></th>
                            <th></th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($lembaga as $lembaga)
                            <tr
                                ...
                                <td class="px-1 py-1 text-gray-900">
                                    ...
                                    href="{{ url('ubahlembaganasional/' . $lembaga->id_jenis_akreditasi) }}">
                                    Edit
                                </a>
                                </td>
                                <td class="px-1 py-1 text-gray-900">
                                <form action="{{ url('hapuslembaganasional/' . $lembaga->id_jenis_akreditasi) }}" method="post">
                                    @method('delete')
                                    @csrf
                                    <button class="bg-red-500 hover:bg-red-700 text-white font-sans py-1 px-1 text-xs rounded"
                                     onclick="return confirm('Yakin dihapus ta om? (iki datae lembaga nasional)')">
                                       <span>hapus</span>
                                    </button>
                                 </form>
                                </td>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" action="{{ url('/simpanlembaganasional') }}"
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <label for="nama"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Lembaga Nasional</label>
