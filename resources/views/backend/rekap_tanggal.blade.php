<x-backend-layout>
    ...
    <form class="max-w-sm mx-auto" method="post" action="{{ url('/kadal') }}">
        @csrf
        <div class="mb-5">
                ...
                <table class="display" id="export-table">
                    <thead class=" text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-200">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Tgl Berakhir Akreditasi Nasional</th>
                    ...
                    <tfoot class="text-xs text-center bg-gray-300 dark:bg-gray-300 dark:text-gray-300">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-gray-900 whitespace-nowrap">Lembaga Akreditasi
                                Nasional</th>
                            <th scope="col" class="px-6 py-3 text-gray-900 whitespace-nowrap">Tgl Berakhir Akreditasi
                                Nasional</th>
