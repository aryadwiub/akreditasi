<nav class="bg-gray-800">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    {{-- <img src="img/logo-bpm-bg-putih-removebg-preview.png" alt="Your Company" class="w-[100px]" /> --}}
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/dashboard"
                            class="{{ request()->is('/dashboard') ? 'bg-gray-800/50 px-3 py-2 text-sm font-medium text-white' : 'px-3 py-2 text-sm font-medium text-white/300 hover:bg-white/5 hover:text-white' }} text-white rounded-md ">Dashboard</a>

                        <a href="/fakultas"
                            class="{{ request()->is('/fakultas') ? 'bg-gray-800/50 px-3 py-2 text-sm font-medium text-white' : 'px-3 py-2 text-sm font-medium text-white/300 hover:bg-white/5 hover:text-white' }} text-white rounded-md">Prodi</a>

                        <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                            class="{{ request()->is('/dashboard') ? 'bg-gray-800/50 px-3 py-2 text-sm font-medium text-white' : 'px-3 py-2 text-sm font-medium text-white/300 hover:bg-white/5 hover:text-white' }} text-white rounded-md ">Rekap
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                ...
                                <li>
                                    <a href="/rekapakreditasi"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Rekap
                                        Akreditasi Aktif</a>
                                </li>
                                <li>
                                    <a href="/rekap_tanggal_awal"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Rekap
                                        Akreditasi Nasional Berdasarkan Tanggal</a>
                                </li>
                                <li>
                                    <a href="/rekap_tanggal_awal_inter"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Rekap
                                        Akreditasi Internasional Berdasarkan Tanggal</a>
                                </li>
                            </ul>
                        </div>

                        <button id="dropdownReferensiLink" data-dropdown-toggle="dropdownReferensi"
                            class="{{ request()->is('/dashboard') ? 'bg-gray-800/50 px-3 py-2 text-sm font-medium text-white' : 'px-3 py-2 text-sm font-medium text-white/300 hover:bg-white/5 hover:text-white' }} text-white rounded-md ">Referensi
                            <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg></button>
                        <div id="dropdownReferensi"
                            class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                                aria-labelledby="dropdownLargeButton">
                                <li>
                                    <a href="/referensifakultas"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Fakultas</a>
                                </li>
                                <li>
                                    <a href="/referensiprodi"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Prodi</a>
                                </li>
                                <li>
                                    <a href="/referensiperingkat"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Peringkat
                                        Akreditasi Nasional</a>
                                </li>
                                <li>
                                    <a href="/referensilembaganasional"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Lembaga
                                        Akreditasi Nasional</a>
                                </li>
                                <li>
                                    <a href="/referensilembagainter"
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Lembaga
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <a href="#"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Prodi</a>
